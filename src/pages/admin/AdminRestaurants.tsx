  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (editingRestaurant) {
        const response = await axios.put(`http://localhost:5000/api/admin/restaurants/${editingRestaurant}`, formData, config);
        console.log('Restaurant updated:', response.data);
      } else {
        const response = await axios.post('http://localhost:5000/api/admin/restaurants', formData, config);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const restaurantData = {
        ...
        minimumOrder: parseFloat(formData.minimumOrder.toString())
      };

      if (editingRestaurant) {
        const response = await axios.put(`/api/admin/restaurants/${editingRestaurant}`, restaurantData);
        console.log('Restaurant updated:', response.data);
      } else {
...
const AdminRestaurants: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editingRestaurant) {
        const response = await axios.put(`http://localhost:5000/api/admin/restaurants/${editingRestaurant}`, formData);
        console.log('Restaurant updated:', response.data);
      } else {
        const response = await axios.post('http://localhost:5000/api/admin/restaurants', formData);
        console.log('Restaurant created:', response.data);
      }
